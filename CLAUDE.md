...
2. [ ] 実データでの案件抽出結果を確認・調整
3. [ ] 実データでのNext.jsダッシュボード表示確認
4. [ ] デプロイ先選定・実施（プラン比較表参照）

#### 中期: 機能改善
5. [ ] 契約形態の分類改善（派遣 vs 準委任）
6. [ ] 給与フォーマット標準化（時給 vs 月給）
7. [ ] AI信頼度スコアの実装
8. [ ] データベースのPostgreSQL移行（Supabase検討）
