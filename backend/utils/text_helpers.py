...
EDUCATION_OPTIONS = ["高校卒", "専門学校卒", "大学卒", "大学院卒（修士）", "大学院卒（博士）"]
INDUSTRY_OPTIONS = ["金融", "医療", "製造", "小売・流通", "通信", "公共・行政", "エンタメ・ゲーム", "不動産", "教育"]
PROFICIENCY_OPTIONS = ["初級", "中級", "上級"]
...
COMPANY_NAME_OVERRIDES: dict[str, str] = {
    "idh": "株式会社アイ・ディ・エイチ",
    "idh-net": "株式会社アイ・ディ・エイチ",
    "webedge": "株式会社ウェブエッジ",
    "web edge inc.": "株式会社ウェブエッジ",
    "g&t": "株式会社G&T",
    "pda": "株式会社プラウドデータ",
    "itether": "株式会社アイテザー",
    "growship": "株式会社Growship",
    "letoile": "株式会社レトワール",
    "3sss": "株式会社3sss",
    "alternaex": "株式会社オルタナエクス",
    "オルタナエクス": "株式会社オルタナエクス",
    "sr-net": "株式会社システムリサーチ",
    "yakudo": "株式会社Yakudo",
    "株式会社　松原": "インターノウス株式会社",
    "株式会社 松原": "インターノウス株式会社",
    "ブレイントラスト": "株式会社ブレイントラスト",
    "ディーメイク": "株式会社ディーメイク",
    "ルートゼロ": "株式会社ルートゼロ",
    "ncsビジネスパートナー": "日本コンピュータシステム株式会社",
    "アーキテクトコア": "株式会社アーキテクトコア",
    "システムエグゼ": "株式会社システムエグゼ",
}
